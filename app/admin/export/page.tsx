  ...
  return (
    <section className="grid gap-4">
      <div className="surface-card p-5">
        ...
        <p className="mt-2 text-sm leading-6 text-ink/65">Download lead data as CSV for finance, ops and reporting.</p>
      </div>
      <div className="surface-card flex flex-wrap items-center justify-between gap-4 p-5">
        <div>
          ...
          <p className="mt-1 text-sm text-ink/65">Includes stage, assignment, territory and referral fields.</p>
        </div>
